...
<body>
	<div class="page-container">
		<h1>用&nbsp;&nbsp;户&nbsp;&nbsp;注&nbsp;&nbsp;册</h1>
		<form action="${pageContext.request.contextPath }/userController/register.action" method="post">
			<div>
			...
			<button id="submit" type="submit" onclick="return checkLogin();">注&nbsp;册</button>
		</form>
		<div class="connect">
